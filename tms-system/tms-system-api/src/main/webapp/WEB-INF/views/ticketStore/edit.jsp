        ...
        <section class="content">
            ...
            <div class="box">
                ...
                <div class="box-header with-border">
                    <h3 class="box-title">景区信息修改</h3>
                    <div class="box-tools pull-right">
                        <button class="btn btn-primary btn-sm"><i class="fa fa-arrow-left"></i> 返回景区详情</button>
                    </div>
                </div>
                ...
                <div class="box-body">
                    <form method="post" id="addForm" enctype="multipart/form-data">
                        <div class="form-group">
                            <label>景区名</label>
                            <input type="text" name="scenicName" class="form-control" value="${scenic.scenicName}">
                        </div>
                        <div class="form-group">
                            <label>星级</label>
