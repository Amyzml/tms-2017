        ...
        <section class="content">
            ...
            <div class="box">
                <div class="box-header with-border">
                    <h3 class="box-title">售票站点列表</h3>
                    <c:if test="${not empty message}">
                        <div class="btn btn-primary btn-sm">${message}</div>
                    </c:if>

                    <div class="box-tools pull-right">
                        <a href="/ticketStore/new" class="btn btn-success btn-sm" id="addCustomer"><i class="fa fa-plus"></i> 新增售票站点</a>
                    </div>
                </div>
                <div class="box-body no-padding">
                    <table class="table table-hover">
                        ...
                        <c:forEach items="${ticketStoreList}" var="ticketStore">
                            <tr class="dataRow" rel="${ticketStore.id}">
                                <td width="80"></td>
...
<script>
    ...
    $(function() {
        ...
        $(".dataRow").click(function () {
            ...
            window.location.href="/ticketStore/detail/" + id;
        });
